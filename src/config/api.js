...
// In production, try to use HTTPS if available, otherwise use Vercel proxy
// If backend supports HTTPS, use: https://139.59.137.138/api/v1
// Otherwise, use Vercel proxy: /api/v1
export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 
  (import.meta.env.DEV ? '/api/v1' : 'https://139.59.137.138/api/v1')
